...
<div class="container g-3  mb-4 mt-4 border">
    <div class="mt-3">
        ...
        <div class="container text-white">
            <div class="row text-white">
                <div class="col-12 text-center text-md-start">
                    <h1>Tornar Funcionário Efectivo</h1>
                </div>
                ...
                <div class="col-12 ">
                    <form class="row g-3 d-flex justify-content-center" action="" method="get">
                        ...
                        <div class="col-8 col-md-6 ">
                            ...
                            <select class="form-select" id="" required wire:model="agencia">
                                <option class="d-none">Selecione</option>
                                @foreach ($agencias as $agencia)
                                    <option value="{{ $agencia->id }}">{{ $agencia->num_indent }}</option>
                                @endforeach
                            </select>
    ...
    <div class="container col-12 border mb-2 text-white">
        <h1 class="text-center text-md-start pt-3">Lista de Funcionários Independentes</h1>
        <div class="col-12 ">
                            ...
                            <tr class="text-white">
                                ...
                                <td class="text-center">
                                    <button class="bg-success" type="button"
                                        wire:click="tornarfuncionario({{ $item->id }})" style="width: 40px">
